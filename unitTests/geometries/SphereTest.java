...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(List.of(new Point(2, 0, 0)),
                sphere.findGeoIntersections(new Ray(new Point(1, -1, 0), new Vector(1, 1, 0))),
                "Ray from sphere inside");
        // TC12: Ray starts at sphere and goes outside (0 points)
        // There are no intersections because it doesn't count the intersection with the ray head
        assertNull(
                sphere.findGeoIntersections(new Ray(new Point(2, 0, 0), new Vector(1, 1, 0))),
                "Ray from sphere outside");

        // **** Group: Ray's line goes through the center
        // TC13: Ray starts before the sphere (2 points)
        result = sphere.findGeoIntersections(new Ray(new Point(1, -2, 0), new Vector(0, 1, 0)));
        ...
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findGeoIntersections(new Ray(new Point(1, -1, 0), new Vector(0, 1, 0))),
                "Line through O, ray from and crosses sphere");
        // TC15: Ray starts inside (1 points)
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findGeoIntersections(new Ray(new Point(1, 0.5, 0), new Vector(0, 1, 0))),
                "Line through O, ray from inside sphere");
        // TC16: Ray starts at the center (1 points)
        assertEquals(List.of(new Point(1, 1, 0)),
                sphere.findGeoIntersections(new Ray(new Point(1, 0, 0), new Vector(0, 1, 0))),
